...
function Card({ moment, isHovered }: MomentCard3DProps) {
  ...
  const { rotation } = useSpring({
    rotation: isHovered ? [0, Math.PI / 6, 0] : [0, 0, 0],
...
export default function MomentCard3DScene({ moment, isHovered }: MomentCard3DProps) {
  return (
    <div className="w-full h-full">
      <Canvas>
        ...
        <Card moment={moment} isHovered={isHovered} />
      </Canvas>
    </div>
  );
}